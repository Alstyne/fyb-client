...
export const NAMSSNLogo = ({ size = 40, className = '' }) => (
  ...
  >
    {/* Outer circle ring */}
    <circle cx="100" cy="95" r="88" fill="white" stroke="#1a1a1a" strokeWidth="3.5"/>
    <circle cx="100" cy="95" r="80" fill="white" stroke="#1a1a1a" strokeWidth="1.2"/>

    {/* Arc text - top: NATIONAL ASSOCIATION OF MATHEMATICAL SCIENCES STUDENTS */}
    <defs>
      <path id="topArc" d="M 20,95 A 80,80 0 0,1 180,95" />
      <path id="bottomArc" d="M 28,115 A 80,80 0 0,0 172,115" />
    </defs>
    <text fontSize="8" fontFamily="Arial, sans-serif" fontWeight="700" fill="#1a1a1a" letterSpacing="1">
    ...
    {/* Lock body */}
    <rect x="46" y="52" width="38" height="32" rx="4" fill="none" stroke="#1a1a1a" strokeWidth="3"/>
    <rect x="50" y="62" width="30" height="26" rx="3" fill="#1a1a1a"/>
    {/* Lock shackle */}
    <path d="M54 52 L54 44 Q54 36 65 36 Q76 36 76 44 L76 52" fill="none" stroke="#1a1a1a" strokeWidth="3.5" strokeLinecap="round"/>
    {/* Lock dial */}
    <circle cx="65" cy="74" r="8" fill="white" stroke="white" strokeWidth="1"/>
    <circle cx="65" cy="74" r="5" fill="none" stroke="#1a1a1a" strokeWidth="1.5"/>
    <line x1="65" y1="69" x2="65" y2="71" stroke="#1a1a1a" strokeWidth="1.2"/>
    <line x1="65" y1="77" x2="65" y2="79" stroke="#1a1a1a" strokeWidth="1.2"/>
    <line x1="60" y1="74" x2="62" y2="74" stroke="#1a1a1a" strokeWidth="1.2"/>
    <line x1="68" y1="74" x2="70" y2="74" stroke="#1a1a1a" strokeWidth="1.2"/>

    {/* Key */}
    <circle cx="118" cy="43" r="10" fill="none" stroke="#1a1a1a" strokeWidth="2.8"/>
    <circle cx="118" cy="43" r="5" fill="none" stroke="#1a1a1a" strokeWidth="1.5"/>
    <line x1="127" y1="51" x2="148" y2="63" stroke="#1a1a1a" strokeWidth="3" strokeLinecap="round"/>
    <line x1="143" y1="60" x2="143" y2="68" stroke="#1a1a1a" strokeWidth="2.5" strokeLinecap="round"/>
    <line x1="148" y1="57" x2="148" y2="65" stroke="#1a1a1a" strokeWidth="2.5" strokeLinecap="round"/>

    {/* Open book */}
    <path d="M85 75 Q100 70 115 75 L115 100 Q100 96 85 100 Z" fill="none" stroke="#1a1a1a" strokeWidth="2.2"/>
    <path d="M115 75 Q130 70 145 75 L145 100 Q130 96 115 100 Z" fill="none" stroke="#1a1a1a" strokeWidth="2.2"/>
    <line x1="115" y1="75" x2="115" y2="100" stroke="#1a1a1a" strokeWidth="2"/>
    {/* Book lines */}
    <line x1="89" y1="82" x2="112" y2="80" stroke="#1a1a1a" strokeWidth="1.2"/>
    <line x1="89" y1="87" x2="112" y2="86" stroke="#1a1a1a" strokeWidth="1.2"/>
    <line x1="89" y1="92" x2="112" y2="91" stroke="#1a1a1a" strokeWidth="1.2"/>
    <line x1="118" y1="80" x2="141" y2="82" stroke="#1a1a1a" strokeWidth="1.2"/>
    <line x1="118" y1="86" x2="141" y2="87" stroke="#1a1a1a" strokeWidth="1.2"/>
    <line x1="118" y1="91" x2="141" y2="92" stroke="#1a1a1a" strokeWidth="1.2"/>
    ...
    {/* NAMSSN text */}
    <text x="101" y="138" textAnchor="middle" fontSize="11" fontFamily="Arial, sans-serif" fontWeight="900" fill="#1a1a1a" letterSpacing="1">NAMSSN</text>

    {/* Ribbon/banner at bottom */}
    <path d="M30 155 L15 163 L30 170 L170 170 L185 163 L170 155 Z" fill="white" stroke="#1a1a1a" strokeWidth="1.5"/>
    <path d="M30 155 L25 163 L30 170" fill="white" stroke="#1a1a1a" strokeWidth="1.5"/>
    <path d="M170 155 L175 163 L170 170" fill="white" stroke="#1a1a1a" strokeWidth="1.5"/>
    <text x="101" y="166" textAnchor="middle" fontSize="10" fontFamily="Georgia, serif" fontStyle="italic" fill="#1a1a1a" fontWeight="700">Critical Thinkers</text>
  </svg>
);
...
export const UniJosLogo = ({ size = 40, className = '' }) => (
  ...
  >
    ...
    <path d="M10 10 L190 10 L190 140 Q190 200 100 215 Q10 200 10 140 Z"
          fill="#1a6fbf" stroke="#1a1a1a" strokeWidth="2"/>

    {/* Shield white stripes */}
    ...
    {/* Mine/tin circle emblem (center of shield) */}
    ...
    {/* Mining ground / reddish-brown area */}
...
// ── Combined logo header for auth pages ───────────────────────────
export const AuthLogoHeader = () => (
  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 20, marginBottom: 24 }}>
    <NAMSSNLogo size={72} />
    <div style={{ textAlign: 'center' }}>
      <div style={{ fontSize: 11, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.15em', marginBottom: 2 }}>
        FYB 2026
      </div>
      <div style={{ fontSize: 13, fontWeight: 700, color: '#1a1a2e', letterSpacing: '0.05em' }}>
        Final Year Book
      </div>
    </div>
    <UniJosLogo size={72} />
